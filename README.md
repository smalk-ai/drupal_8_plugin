...
**Monetize AI Agent traffic with server-side ads for Drupal 8.**

> **Note**: This is the Drupal 8 version. For Drupal 9/10/11, use the `smalk/` folder instead.
...
1. Download the `smalk` folder (rename from `smalk_d8` if needed)
...
## Differences from Drupal 9/10/11 Version

- Uses CKEditor 4 hooks instead of CKEditor 5 plugin
- PHP 7.0+ compatible (no typed properties)
- No CKEditor 5 dependency
